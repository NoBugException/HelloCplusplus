...
void Ls_11_03::printChar()
{
    n_Ls_11_03::COperator optr1;                        //定义一个COperator对象，调用自身无参构造函数
    n_Ls_11_03::COperator optr2("LaoZhang");           //定义一个COperator对象，调用自身带参数构造函数
}
